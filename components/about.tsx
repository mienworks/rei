    ...
    <Dialog open={open} onOpenChange={setOpen}>
          ...
          <TooltipTrigger asChild>
            <DialogTrigger asChild>
              <Button size="icon-sm" variant="ghost">
                ...
                <span className="sr-only">About Mien Rei</span>
              </Button>
            </DialogTrigger>
          </TooltipTrigger>
          <TooltipContent>About Mien Rei</TooltipContent>
        </Tooltip>
      </TooltipProvider>
      <DialogContent className="w-[20rem] max-w-[calc(100vw-2rem)]">
        <DialogHeader className="items-center gap-3 text-center">
          ...
          <DialogDescription>
            Edit static-site content directly on GitHub with a focused
            interface.
          </DialogDescription>
          <p className="text-xs text-muted-foreground">
            Powered by{" "}
            <ExternalLink href="https://pagescms.org">Pages CMS</ExternalLink>
          </p>
        </DialogHeader>
